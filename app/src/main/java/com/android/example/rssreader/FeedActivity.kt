...
class FeedActivity : AppCompatActivity() {
    ...
    // view
    private val rv by lazy { findViewById<RecyclerView>(R.id.screen2) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rv.adapter = RSSFeedAdaptor(rssFeedList)
        title = topicUrl.capitalize()
    ...
    private fun onRssFailure(call: Call<RSSWrapper?>?, t: Throwable?) {
        ...
        Log.e("fetch_error", "user articles could not be fetched")
